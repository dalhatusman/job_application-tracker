...
import { CheckCircle2, Mic, Award, XCircle, Trash2 } from "lucide-react";
...
function DroppableColumn({
  ...
  const sortedJobs =
    column.jobApplications?.sort((a, b) => a.order - b.order) || null;
  return (
          ...
          <DropdownMenu>
            <DropdownMenuTrigger>
              <Button
                variant="ghost"
                size="icon"
                className="h-6 w-6 text-white hovering:bg-white/20"
              >
            ...
            <DropdownMenuContent align="end">
              <DropdownMenuItem className="text-destructive">
                <Trash2 className="mr-2 h-4 w-4">Delete Column</Trash2>
              </DropdownMenuItem>
            </DropdownMenuContent>
          </DropdownMenu>
        </div>
